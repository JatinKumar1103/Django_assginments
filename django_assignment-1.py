...
class Register:
    ...
    def register_data(self):
        ...
        try:
            workbook = openpyxl.load_workbook("django_assignment-1_excel.xlsx")
            sheet = workbook.active
        ...
        workbook.save("django_assignment-1_excel.xlsx")
        
        
        print("Data saved to django_assignment-1_excel.xlsx")
